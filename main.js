...
function getStory(playerName) {
    return {
        ...
        takepillending: {
            title: "<span>You died.</span>",
            description: "You decide to take the pill. All you can think about is getting some sleep without troubling your mind with how and why you are here. You don't think it's important anyway. You drift away and never wake up again.",
            defaultDestination: "begin",
            buttonText:"Try again"
        },
...
function renderScene(){
    ...
    content.innerHTML=`
        ...
        ${getInputs()}
        <button id="submit-button" class="button">${text}</button>
     `
